...
$new_address_err = $new_city_err = $new_zip_err = $check_err = $new_state_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($_POST["check"])){
        $check_err = "Please select this box to continue.";
    } 
    ...
    // if(empty($new_address_err) && empty($new_city_err) && empty($new_zip_err) && empty($check_err)){
    //     // Prepare a select statement
    //     $sql = "UPDATE address, City, State, Zip FROM accounts WHERE id = '". $_SESSION["id"]."'";
